      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        <div className="bg-black/70 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-700/50 overflow-hidden">
          <div className="p-8">
                ...
                <div className="space-y-6">
                   <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-800/50 border border-gray-600 rounded-lg py-3 px-4 text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all outline-none text-left"
                      dir="ltr"
                      required
                    />
                  </div>
            ...
            <button onClick={handlePlaceholderClick} className="w-full flex items-center justify-center bg-gray-700/20 hover:bg-gray-700/40 border border-gray-600 text-gray-200 font-semibold py-3 px-4 rounded-lg transition-all duration-300 space-x-3 space-x-reverse">
